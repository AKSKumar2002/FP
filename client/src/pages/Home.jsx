    ...
    <div className='relative bg-gray-50 min-h-screen pb-20'>
      ...
      <div className="relative mt-4 md:mt-20 bg-gradient-to-br from-green-50 to-emerald-50 md:rounded-3xl p-2 md:p-12 md:shadow-xl md:mx-0 mx-0">
        <div className="text-center mb-6 md:mb-10">
          ...
          <p className="text-gray-600 text-sm md:text-lg">Farm-fresh produce delivered daily</p>
          <div className="w-16 md:w-24 h-1 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full mx-auto mt-2 md:mt-3"></div>
        </div>
        <BestSeller />
      </div>
      ...
      <a
        href="https://wa.me/918825935176"
        target="_blank"
        rel="noopener noreferrer"
        className="hidden md:flex fixed bottom-8 right-8 z-50 hover:-translate-y-1 transition-transform duration-300"
        title="Chat with us on WhatsApp"
      >
        <div className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 relative group">
          {/* WhatsApp SVG Icon */}
          ...
          {/* Tooltip */}
          <span className="absolute right-full top-1/2 -translate-y-1/2 mr-4 px-3 py-1 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
            Chat on WhatsApp
          </span>
        </div>
      </a>
