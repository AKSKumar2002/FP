...
const Contact = () => {
  ...
  return (
    <div className="px-4 py-12 md:px-20 bg-white dark:bg-gray-900 min-h-screen transition">
      ...
      <motion.div
        ...
        className="max-w-5xl mx-auto bg-green-50 dark:bg-gray-800 text-gray-800 dark:text-white rounded-2xl shadow-xl overflow-hidden"
      >
        <div className="grid md:grid-cols-2 gap-8 p-10">
          {/* Info */}
          <div className="space-y-5">
            <h2 className="text-4xl font-bold text-green-700 dark:text-green-400">Get in Touch</h2>
            ...
            <div className="h-52 rounded-xl overflow-hidden border-2 border-green-600 shadow-lg">
              <iframe
              ...
              >
                {field !== 'message' ? (
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500"
                  />
                ) : (
                  <textarea
                    rows="5"
