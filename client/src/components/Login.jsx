                        ...
                        <div className="space-y-6">
                            <div className="flex justify-center gap-2 my-4">
                                <input
                                    ...
                                    className="w-80 text-center text-3xl font-bold tracking-[0.5em] py-2 border-b-2 border-green-500 outline-none focus:border-green-700 transition-colors bg-transparent"
                                    placeholder="••••••"
                                    autoFocus
                                />
                            </div>
