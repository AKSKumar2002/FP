...
const Navbar = ({ onMenuClick }) => {
  ...
  return (
    <nav className="backdrop-blur-md bg-[rgba(255,255,255,0.65)] text-black border-b border-gray-300 shadow-md px-4 md:px-12 lg:px-20 xl:px-28 py-2 sticky top-0 z-50 transition-all">
      {/* ========== MOBILE ONLY - Logo + Hamburger ========== */}
      <div className="md:hidden flex items-center justify-between w-full h-[48px]">
        {/* Logo LEFT */}
        <NavLink
          to="/"
          onClick={() => {
